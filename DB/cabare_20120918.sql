/******************************************************************************/
/***          Generated by IBExpert 2012.03.13 18.09.2012 17:32:25          ***/
/******************************************************************************/
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_MENU_GRP', 'New', 'select id, name, is_addon from cbr_menu_grp where id is null', 'insert into cbr_menu_grp(id, name, is_addon) values(:id, :name, :is_addon)', 'select gen_id(cbr_gen, 1) id, 0 as is_addon from rdb$database', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_MENU_GRP', 'Item', 'select id, name, is_addon from cbr_menu_grp where id = :id', NULL, NULL, 'update cbr_menu_grp set name = :name, is_addon = :is_addon where id = :id', NULL, NULL, NULL, 0, NULL, 0, NULL, NULL);
...
where exists(select * from cbr_menu m where m.grp_id = g.id and m.state_id = 1)
order by g.name', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_ORD_DESK', 'Items', 'select * from cbr_ev_ord_desk_ordi(:id, :hid)', 'insert into cbr_ordi(id, hid, menu_id, qty, price, parent_id) values(:id, :hid, :menu_id, :qty, :price, :parent_id)', '', 'update cbr_ordi set qty = :qty where id = :id', 'delete from cbr_ordi where id = :id', 'select * from cbr_ev_ord_desk_ordi(:id, null)', NULL, 0, NULL, 0, NULL, NULL);
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_ORD_DESK', 'ItemInit', 'select * from cbr_ev_ord_desk_ordi_i(:hid, :menu_id, :parent_id)', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, NULL);
...
begin
  ...
  for
    ...
    union all
    select m.id, m.name, m.grp_id
    from cbr_menu_grp g left join cbr_menu m on (g.id = m.grp_id)
    where g.is_addon = 1  and :parent_id_ is not null
          and m.state_id = 1
          and exists (select * from cbr_price p where p.menu_id = m.id)
    into :id, :name, :grp_id
  do suspend;
