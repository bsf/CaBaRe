/******************************************************************************/
/***          Generated by IBExpert 2012.03.13 04.05.2012 17:46:20          ***/
/******************************************************************************/
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, OPTIONS, IS_EXEC, SQL_INSERTDEF) VALUES ('CBR_UI', 'MainMenu', 'select  u.uri, u.title from bfw_ui u where u.uri in (''views.CBR_MENU.List'', ''views.CBR_TBL.List'', ''views.CBR_PRICE.List'', ''views.CBR_WAITER_DESK.view'')', NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL);
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, READONLY, PKEY, OPTIONS, IS_EXEC, SQL_INSERTDEF) VALUES ('CBR_WD_VIEW', 'Tables', 'select t.id, r.name room, t.name from cbr_tbl t left join cbr_rooms r on (r.id = t.room_id) order by r.name, t.name', NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, NULL);
...
INSERT INTO BFW_UI (URI, CLS, ENTITYNAME, VIEWNAME, TITLE, GRP, MENUIDX, OPTIONS, PARAMS, OUTS, USEPERM, PKG) VALUES ('views.CBR_MENU.List', 'IEntityListView', 'CBR_MENU', 'List', 'Меню', 'Система', 0, 'CanEdit', NULL, NULL, 0, 'CBR');
...
INSERT INTO BFW_UI (URI, CLS, ENTITYNAME, VIEWNAME, TITLE, GRP, MENUIDX, OPTIONS, PARAMS, OUTS, USEPERM, PKG) VALUES ('views.CBR_WAITER_DESK.view', 'views.CBR_WAITER_DESK.view', '-', NULL, 'Заказы', NULL, 0, NULL, NULL, NULL, 0, NULL);
...
INSERT INTO BFW_UI (URI, CLS, ENTITYNAME, VIEWNAME, TITLE, GRP, MENUIDX, OPTIONS, PARAMS, OUTS, USEPERM, PKG) VALUES ('views.CBR_PRICE.List', 'IEntityListView', 'CBR_PRICE', 'List', 'Цены', 'Система', 0, 'UseSelector', NULL, NULL, 0, 'CBR');
...
INSERT INTO BFW_UI (URI, CLS, ENTITYNAME, VIEWNAME, TITLE, GRP, MENUIDX, OPTIONS, PARAMS, OUTS, USEPERM, PKG) VALUES ('views.CBR_TBL.List', 'IEntityListView', 'CBR_TBL', 'List', 'Столы', 'Система', 0, 'CanEdit', NULL, NULL, 0, 'CBR');
...
INSERT INTO BFW_UI (URI, CLS, ENTITYNAME, VIEWNAME, TITLE, GRP, MENUIDX, OPTIONS, PARAMS, OUTS, USEPERM, PKG) VALUES ('views.CBR_ORD.Journal', 'IEntityJournalView', 'CBR_ORD', 'Journal', 'Журанал заказов', 'Система', 0, 'CanOpen', NULL, NULL, 0, 'CBR');
...
INSERT INTO BFW_UI_CMD (URI, CMD, CAPTION, IDX, GRP, DEF, HANDLER, PARAMS, OUTS, OPTIONS) VALUES ('views.CBR_WAITER_DESK.view', 'cmd.OrdJrn', 'Журнал заказов', 0, NULL, 0, 'views.CBR_ORD.Journal', NULL, NULL, NULL);
