/******************************************************************************/
/***          Generated by IBExpert 2012.03.13 02.10.2012 16:23:38          ***/
/******************************************************************************/
...
CREATE OR ALTER PROCEDURE CBR_EV_KORD_PRINT (
    ID_ INTEGER)
RETURNS (
    ID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_CREATE (
    TBL_ID_ INTEGER)
RETURNS (
    ID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_DEL (
    ID_ INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_DESK_MENU (
    GRP_ID_ INTEGER,
    PARENT_ID_ INTEGER)
RETURNS (
    ID INTEGER,
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_DETAIL_DEL (
    ID_ INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_DETAIL_NEW (
    HID_ INTEGER,
    MENU_ID_ INTEGER,
    PARENT_ID_ INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_DETAILS (
    ID_ INTEGER,
    HID_ INTEGER)
RETURNS (
    ID INTEGER,
...
CREATE OR ALTER PROCEDURE INF_RAISE (
    MSG_CODE VARCHAR(50))
AS
BEGIN
  EXIT;
...
INSERT INTO BFW_ENT_FIELDS (ENTITYNAME, VIEWNAME, FIELDNAME, BAND, TITLE, VISIBLE, READONLY, EDITOR, EDITOR_OPTIONS, OPTIONS, REQ) VALUES ('CBR_ORD', 'DetailKOrd', 'KITCHEN', NULL, 'Кухня', 1, 0, NULL, NULL, NULL, 0);
INSERT INTO BFW_ENT_FIELDS (ENTITYNAME, VIEWNAME, FIELDNAME, BAND, TITLE, VISIBLE, READONLY, EDITOR, EDITOR_OPTIONS, OPTIONS, REQ) VALUES ('CBR_ORD', 'DetailItems', 'ID', NULL, NULL, -1, 0, NULL, NULL, NULL, 0);
INSERT INTO BFW_ENT_FIELDS (ENTITYNAME, VIEWNAME, FIELDNAME, BAND, TITLE, VISIBLE, READONLY, EDITOR, EDITOR_OPTIONS, OPTIONS, REQ) VALUES ('CBR_MENU_GRP', 'Item', 'KITCHEN_ID', NULL, 'Кухня', 1, 0, 'Lookup', 'Entity=CBR_KITCHEN;EView=Lookup', NULL, 0);
INSERT INTO BFW_ENT_FIELDS (ENTITYNAME, VIEWNAME, FIELDNAME, BAND, TITLE, VISIBLE, READONLY, EDITOR, EDITOR_OPTIONS, OPTIONS, REQ) VALUES ('CBR_MENU_GRP', 'List', 'KITCHEN', NULL, 'Кухня', 1, 0, NULL, NULL, NULL, 0);
INSERT INTO BFW_ENT_FIELDS (ENTITYNAME, VIEWNAME, FIELDNAME, BAND, TITLE, VISIBLE, READONLY, EDITOR, EDITOR_OPTIONS, OPTIONS, REQ) VALUES ('CBR_MENU_GRP', 'New', 'KITCHEN_ID', NULL, 'Кухня', 1, 0, 'Lookup', 'Entity=CBR_KITCHEN;EView=Lookup', NULL, 0);
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_MENU_GRP', 'List', 'select g.id, g.name, g.idx, a.name addon_grp, g.is_addon, k.name kitchen 
from cbr_menu_grp g left join cbr_menu_grp a on (g.addon_grp_id = a.id) left join cbr_kitchens k on (k.id = g.kitchen_id)
order  by g.idx', NULL, NULL, NULL, 'delete from cbr_menu_grp where id = :id', 'select g.id, g.name, g.idx, a.name addon_grp, g.is_addon, k.name kitchen 
from cbr_menu_grp g left join cbr_menu_grp a on (g.addon_grp_id = a.id) left join cbr_kitchens k on (k.id = g.kitchen_id)
where g.id = :id', NULL, 1, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_MENU_GRP', 'New', 'select id, name, idx, is_addon, addon_grp_id, kitchen_id from cbr_menu_grp where id is null', 'insert into cbr_menu_grp(id, name, idx, is_addon, addon_grp_id, kitchen_id) values(:id, :name, :idx, :is_addon, :addon_grp_id, :kitchen_id)', 'select gen_id(cbr_gen, 1) id, 0 as is_addon from rdb$database', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_MENU_GRP', 'Item', 'select id, name, idx, is_addon, addon_grp_id, kitchen_id from cbr_menu_grp where id = :id', NULL, NULL, 'update cbr_menu_grp set name = :name, idx = :idx, is_addon = :is_addon, addon_grp_id = :addon_grp_id, kitchen_id = :kitchen_id where id = :id', NULL, NULL, NULL, 0, NULL, 0, NULL, NULL);
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_KORD', 'Create', 'execute procedure cbr_ev_kord_create(:ord_id)', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, NULL, NULL);
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_ORD', 'DetailItems', 'select i.id, 
...
where i.hid = :hid
order by i.id', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, 'Блюда', NULL);
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_ORD', 'DetailKOrd', 'select h.id, h.idat, k.name kitchen from cbr_kord h left join cbr_kitchens k on (k.id = h.kitchen_id) 
where h.ord_id = :hid', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, 'Бегунки', NULL);
...
INSERT INTO BFW_ENT_VIEWS (ENTITYNAME, VIEWNAME, SQL_SELECT, SQL_INSERT, SQL_INSERTDEF, SQL_UPDATE, SQL_DELETE, SQL_REFRESH, SQL_TITLE, READONLY, PKEY, IS_EXEC, TITLE, OPTIONS) VALUES ('CBR_KORD', 'NotPrinted', 'select h.id, k.printer
from cbr_kord h
...
/* Trigger: CBR_KORD_BU */
CREATE OR ALTER TRIGGER CBR_KORD_BU FOR CBR_KORD
ACTIVE BEFORE UPDATE POSITION 0
as
begin
