/******************************************************************************/
/***          Generated by IBExpert 2012.03.13 17.09.2012 13:35:22          ***/
/******************************************************************************/
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_HEAD (
    ID_ INTEGER)
RETURNS (
    ID INTEGER,
    DAT DATE,
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_LIST (
    ID_ INTEGER,
    DBEG_ DATE,
    DEND_ DATE)
RETURNS (
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_PAYT (
    ID_ INTEGER)
RETURNS (
    ID INTEGER,
    DAT DATE,
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_PAYT_U (
    ID_ INTEGER,
    SUMM_PAYT DOUBLE PRECISION)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE CBR_EV_ORD_SELECTOR (
    DAT1_ DATE,
    DAT2_ DATE)
RETURNS (
    DAT1 DATE,
...
begin
  ...
  begin
   /* select msg from inf_msg where code = 'ERROR.PRECHECK'
    ...
    exception raise :msg;*/
    exception raise 'Есть невыполненный заказ!';
  end
