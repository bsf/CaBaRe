/******************************************************************************/
/***          Generated by IBExpert 2012.04.18 27.09.2012 16:14:34          ***/
/******************************************************************************/
...
SET GENERATOR CBR_GEN_DOC TO 829;
...
INSERT INTO CBR_KITCHENS (ID, NAME, PRINTER) VALUES (206, 'Основная', '');
INSERT INTO CBR_KITCHENS (ID, NAME, PRINTER) VALUES (208, 'Пицерия', '1Microsoft XPS Document Writer (копия 1)1');
...
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (37, 'Пицца  - 22см. баран', 35, 1, 'пор.', NULL, NULL, 208);
...
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (67, 'Пицца  - 30см.баран', 35, 1, 'п', NULL, NULL, 208);
...
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (134, 'перец бол.', 125, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (135, 'грибы', 182, 1, 'п', NULL, NULL, NULL);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (136, 'помидоры', 125, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (137, '2-е мясо', 125, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (139, '2-е мясо', 182, 1, 'п', NULL, NULL, NULL);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (140, 'грибы', 125, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (141, 'сыр', 125, 1, 'п', NULL, NULL, 208);
...
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (170, 'Пицца  - 22см. курин', 35, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (173, 'Пицца  - 30см.кур', 35, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (175, 'Пицца без мяса', 125, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (176, 'Пицца  без грибов', 125, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (177, 'Пицца без бол.пер.', 125, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (178, 'Пицца без сыра', 125, 1, 'п', NULL, NULL, 208);
INSERT INTO CBR_MENU (ID, NAME, GRP_ID, STATE_ID, UNT, IDX, ADDON_GRP_ID, KITCHEN_ID) VALUES (179, 'Пицца без помидор', 125, 1, 'п', NULL, NULL, 208);
